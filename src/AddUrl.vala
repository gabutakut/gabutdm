...
namespace Gabut {
    public class AddUrl : Gtk.Dialog {
        ...
        construct {
            ...
            alllink.attach (headerlabel (_("Address:"), 380), 1, 1, 1, 1);
            alllink.attach (link_entry, 1, 2, 1, 1);
            alllink.attach (headerlabel (_("Filename:"), 380), 1, 3, 1, 1);
            ...
            proxygrid.attach (headerlabel (_("Host:"), 140), 0, 2, 1, 1);
            proxygrid.attach (proxy_entry, 0, 3, 1, 1);
            proxygrid.attach (headerlabel (_("Port:"), 140), 1, 2, 1, 1);
            proxygrid.attach (port_entry, 1, 3, 1, 1);
            proxygrid.attach (headerlabel (_("Username:"), 140), 0, 4, 1, 1);
            ...
            logingrid.attach (headerlabel (_("User:"), 310), 1, 1, 1, 1);
            logingrid.attach (loguser_entry, 1, 2, 1, 1);
            logingrid.attach (headerlabel (_("Password:"), 310), 1, 3, 1, 1);
            ...
            moregrid.attach (headerlabel (_("User Agent:"), 300), 1, 0, 1, 1);
            moregrid.attach (useragent_entry, 1, 1, 1, 1);
            moregrid.attach (headerlabel (_("Referer:"), 300), 1, 2, 1, 1);
            ...
            checksumgrid.attach (headerlabel (_("Type:"), 300), 1, 0, 1, 1);
            checksumgrid.attach (checksum_button, 1, 1, 1, 1);
            checksumgrid.attach (headerlabel (_("Hash:"), 300), 1, 2, 1, 1);
            ...
            encryptgrid.attach (headerlabel (_("BitTorrent Seed:"), 300), 1, 0, 1, 1);
            encryptgrid.attach (integrity, 1, 1, 1, 1);
            encryptgrid.attach (unverified, 1, 2, 1, 1);
            encryptgrid.attach (headerlabel (_("BitTorrent Encryption:"), 300), 1, 3, 1, 1);
